...
RUN sed -i 's/<\/Host>/<Valve className="org.apache.catalina.valves.RemoteIpValve" protocolHeader="X-Forwarded-Proto" \/><\/Host>/' /apache-tomcat/conf/server.xml \
